...
public class TestMp {
    ...
    private static String author ="***";//作者名称
    private static String outputDir ="E:\\新建文件夹\\newbee-mall\\src\\main\\java";//生成的位置,一直到项目的java目录
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/newbee_mall_db?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&useSSL=false";
    private static String username ="root";//数据库用户名
    private static String password ="123456";//数据库密码
    //private static String tablePrefix ="sys";//数据库表的前缀，如tbl_user
    private static String [] tables = {"tb_newbee_mall_user","tb_newbee_mall_shopping_cart_item","tb_newbee_mall_order_item","tb_newbee_mall_order","tb_newbee_mall_index_config","tb_newbee_mall_goods_info","tb_newbee_mall_goods_category","tb_newbee_mall_carousel","tb_newbee_mall_admin_user"}; //生成的表
    private static String parentPackage = "com.example.newbeemall";//顶级包结构
