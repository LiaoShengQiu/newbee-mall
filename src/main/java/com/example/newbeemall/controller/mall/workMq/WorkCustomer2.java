...
public class WorkCustomer2 {
    ...
    public void processA(Result msg)  throws InterruptedException{
        System.out.println(msg.getId()+"ReceiveBjinglaile进来了====================="+msg+"\tqqqqq"+msg.getMessage());
        //Thread.sleep(3000);
        logger.info("ReceiveB:"+msg.toString());
